...
import { IChannel, IEditMsgReq, IMessage, ISendMsgReq, IStartConversationReq, IUser } from 'vio-assessment-solution.contracts';
...
export class MessagesService {
  ...
  constructor (channelsService: ServicesService) {
