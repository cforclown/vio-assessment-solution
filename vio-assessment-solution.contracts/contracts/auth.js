...
exports.authSwagger = exports.refreshTokenReqSchema = exports.registerReqSchema = exports.passwordSchema = exports.usernameSchema = exports.loginReqSchema = void 0;
 ...
 */
exports.usernameSchema = joi_1.default.string().regex(/^(?=[a-zA-Z0-9._]{6,24}$)(?!.*[_.]{2})[^_.].*[^_.]$/).required();
/**
 * NOTE!
 *
 * password RULEs ->
 ...
 */
exports.passwordSchema = joi_1.default.string().regex(/^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?!.* ).{8,24}$/).required();
